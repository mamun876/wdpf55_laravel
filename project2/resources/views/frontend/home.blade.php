            ...
            <div class="box-swiper">
              <div class="swiper-container swiper-group-9 swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/microsoft.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/sony.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/acer.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/nokia.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/assus.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/casio.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/dell.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/panasonic.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/vaio.svg" alt="jobBox"></a></div>
                  <div class="swiper-slide"><a href="#"><img src="frontend/assets/imgs/slider/logo/sharp.svg" alt="jobBox"></a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="text-start">
            ...
            <div class="list-tabs mt-40">
              <ul class="nav nav-tabs" role="tablist">
                <li><a class="active" id="nav-tab-job-1" href="#tab-job-1" data-bs-toggle="tab" role="tab" aria-controls="tab-job-1" aria-selected="true"><img src="frontend/assets/imgs/page/homepage1/management.svg" alt="jobBox"> Management</a></li>
                <li><a id="nav-tab-job-2" href="#tab-job-2" data-bs-toggle="tab" role="tab" aria-controls="tab-job-2" aria-selected="false"><img src="frontend/assets/imgs/page/homepage1/marketing.svg" alt="jobBox"> Marketing &amp; Sale</a></li>
                <li><a id="nav-tab-job-3" href="#tab-job-3" data-bs-toggle="tab" role="tab" aria-controls="tab-job-3" aria-selected="false"><img src="frontend/assets/imgs/page/homepage1/finance.svg" alt="jobBox"> Finance</a></li>
                <li><a id="nav-tab-job-4" href="#tab-job-4" data-bs-toggle="tab" role="tab" aria-controls="tab-job-4" aria-selected="false"><img src="frontend/assets/imgs/page/homepage1/human.svg" alt="jobBox"> Human Resource</a></li>
                <li><a id="nav-tab-job-5" href="#tab-job-5" data-bs-toggle="tab" role="tab" aria-controls="tab-job-5" aria-selected="false"><img src="frontend/assets/imgs/page/homepage1/retail.svg" alt="jobBox"> Retail &amp; Products</a></li>
                <li><a id="nav-tab-job-6" href="#tab-job-6" data-bs-toggle="tab" role="tab" aria-controls="tab-job-6" aria-selected="false"><img src="frontend/assets/imgs/page/homepage1/content.svg" alt="jobBox"> Content Writer</a></li>
              </ul>
            </div>
          </div>
          <div class="mt-50">
                ...
                <div class="row">
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot bg-green"><span>Freelancer</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img1.png" alt="jobBox"></figure>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img2.png" alt="jobBox"></figure>
                        </div>
                      </div>
                      <div class="card-block-info">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img3.png" alt="jobBox"></figure>
                        </div>
                      </div>
                      <div class="card-block-info">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img4.png" alt="jobBox"></figure>
                        </div>
                      </div>
                      <div class="card-block-info">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img5.png" alt="jobBox"></figure>
                        </div>
                      </div>
                      <div class="card-block-info">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                        <div class="image-box">
                          <figure><img src="frontend/assets/imgs/page/homepage2/img6.png" alt="jobBox"></figure>
                        </div>
                      </div>
                      <div class="card-block-info">
              ...
              <div class="swiper-container swiper-group-6 mh-none swiper">
                <div class="swiper-wrapper pb-70 pt-5">
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('frontend/assets/imgs/page/homepage2/img-big1.png')"><a href="jobs-grid.html">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('frontend/assets/imgs/page/homepage2/img-big2.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('frontend/assets/imgs/page/homepage2/img-big3.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
            ...
            <div class="row mt-50">
              <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location1.png);"><span class="lbl-hot">Hot</span></div></a>
              ...
              <div class="col-xl-4 col-lg-4 col-md-7 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location2.png);"><span class="lbl-hot">Trending</span></div></a>
                  <div class="informations"><a href="jobs-grid.html">
              ...
              <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location3.png);"><span class="lbl-hot">Hot</span></div></a>
                  <div class="informations"><a href="jobs-grid.html">
              ...
              <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location4.png);"></div></a>
                  <div class="informations"><a href="jobs-grid.html">
              ...
              <div class="col-xl-5 col-lg-5 col-md-7 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location5.png);"></div></a>
                  <div class="informations"><a href="jobs-grid.html">
              ...
              <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                    <div class="image" style="background-image: url(frontend/assets/imgs/page/homepage1/location6.png);"></div></a>
                  <div class="informations"><a href="jobs-grid.html">
              ...
              <div class="swiper-wrapper pt-5">
                <div class="swiper-slide">
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-1.png"></div>
                        <div class="text-info-right">
                          <h4>Linkedin</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>68</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-2.png"></div>
                        <div class="text-info-right">
                          <h4>Adobe</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>42</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-3.png"></div>
                        <div class="text-info-right">
                          <h4>Dailymotion</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>46</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-4.png"></div>
                        <div class="text-info-right">
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-5.png"></div>
                        <div class="text-info-right">
                          <h4>PowerHome</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>87</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-6.png"></div>
                        <div class="text-info-right">
                          <h4>Whop.com</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>34</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-7.png"></div>
                        <div class="text-info-right">
                          <h4>Greewood</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>124</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-8.png"></div>
                        <div class="text-info-right">
                          <h4>Kentucky</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>54</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-9.png"></div>
                        <div class="text-info-right">
                          <h4>Qeuity</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>76</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-10.png"></div>
                        <div class="text-info-right">
                          <h4>Honda</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>89</span><span>)</span></span>
                        </div>
                        <div class="text-info-bottom mt-5"><span class="font-xs color-text-mutted icon-location">New York, US</span><span class="font-xs color-text-mutted float-end mt-5">34<span> Open Jobs</span></span></div>
                      </div></a></div>
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-3.png"></div>
                        <div class="text-info-right">
                          <h4>Lexuxs</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>27</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-2.png"></div>
                        <div class="text-info-right">
                          <h4>Square</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>16</span><span>)</span></span>
                        </div>
                  ...
                  <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a href="#">
                      <div class="item-logo">
                        <div class="image-left"><img alt="jobBox" src="frontend/assets/imgs/brands/brand-8.png"></div>
                        <div class="text-info-right">
                          <h4>Vista</h4><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><img alt="jobBox" src="frontend/assets/imgs/template/icons/star.svg"><span class="font-xs color-text-mutted ml-10"><span>(</span><span>97</span><span>)</span></span>
                        </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 mb-15 mb-lg-0">
              <div class="box-radius-8 bg-urgent hover-up">
                <div class="image">
                  <figure><img src="frontend/assets/imgs/page/homepage2/job-tools.png" alt="jobBox"></figure>
                </div>
                <div class="text-info">
            ...
            <div class="col-lg-6 col-md-12">
              <div class="box-radius-8 bg-9 hover-up">
                <div class="image">
                  <figure><img src="frontend/assets/imgs/page/homepage2/planning-job.png" alt="jobBox"></figure>
                </div>
                <div class="text-info">
              ...
              <div class="swiper-container swiper-group-3 swiper">
                <div class="swiper-wrapper pb-70 pt-5">
                  <div class="swiper-slide">
                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                      <div class="text-center card-grid-3-image"><a href="#">
                          <figure><img alt="jobBox" src="frontend/assets/imgs/page/homepage1/img-news1.png"></figure></a></div>
                      <div class="card-block-info">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-6 col-6">
                              <div class="d-flex"><img class="img-rounded" src="frontend/assets/imgs/page/homepage1/user1.png" alt="jobBox">
                  ...
                  <div class="swiper-slide">
                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                      <div class="text-center card-grid-3-image"><a href="#">
                          <figure><img alt="jobBox" src="frontend/assets/imgs/page/homepage1/img-news2.png"></figure></a></div>
                      <div class="card-block-info">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-6 col-6">
                              <div class="d-flex"><img class="img-rounded" src="frontend/assets/imgs/page/homepage1/user2.png" alt="jobBox">
                  ...
                  <div class="swiper-slide">
                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                      <div class="text-center card-grid-3-image"><a href="#">
                          <figure><img alt="jobBox" src="frontend/assets/imgs/page/homepage1/img-news3.png"></figure></a></div>
                      <div class="card-block-info">
                        <div class="tags mb-15"><a class="btn btn-tag" href="blog-grid.html">News</a></div>
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-6 col-6">
                              <div class="d-flex"><img class="img-rounded" src="frontend/assets/imgs/page/homepage1/user3.png" alt="jobBox">
      ...
      <section class="section-box mt-50 mb-20">
        <div class="container">
          <div class="box-newsletter">
            <div class="row">
              <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img src="frontend/assets/imgs/template/newsletter-left.png" alt="joxBox"></div>
              ...
              <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img src="frontend/assets/imgs/template/newsletter-right.png" alt="joxBox"></div>
            </div>
          </div>
        </div>
      </section>
