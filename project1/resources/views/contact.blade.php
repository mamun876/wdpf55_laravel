        ...
        <!-- error message -->
            ...
            <form method="post" action="send">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{old('email')}}" name="email" class="form-control" id="email" placeholder="Enter your email" >
                    @error('email')
                    <div class="form-text alert alert-danger" id="emailhelp">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="message"  name="message" rows="5" placeholder="Enter your message" >{{old('message')}}</textarea>
                    @error('message')
                    <div class="form-text alert alert-danger" id="emailhelp">{{$message}}</div>
                    @enderror
                </div>
