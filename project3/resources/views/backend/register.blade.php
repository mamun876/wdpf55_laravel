            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate action="{{ route('register') }}">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password_confirmation" class="form-control" id="confrimpassword" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>
